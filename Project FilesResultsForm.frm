...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ResultsForm 
   ...
   ClientTop       =   450
   ClientWidth     =   17670
   OleObjectBlob   =   "Project FilesResultsForm.frx":0000
   ShowModal       =   0   'False
...
Private Sub btnCopy_Click()
    ...
    piecesStr = Replace(Replace(piecesStr, ",", application.International(xlDecimalSeparator)), ".", application.International(xlDecimalSeparator))
