...
Private Function UpdateComponentDetails(targetRow As ListRow) As String
    ...
    ' Hier setzen wir die Formel f�r "LAPP Item" explizit.
    ' Wir pr�fen erst, ob die Spalte existiert, um Fehler zu vermeiden.
    ...
    If lappColIndex > 0 Then
        ...
        ' Das verhindert, dass die Formel als blo�er Text angezeigt wird.
        ...
        ' Formel nur schreiben, wenn sie sich ge�ndert hat (vermeidet unn�tige Neuberechnungen)
